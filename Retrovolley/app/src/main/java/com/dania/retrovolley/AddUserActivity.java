...
import com.dania.retrovolley.retrofit.MethodHTTP;
...
public class AddUserActivity extends AppCompatActivity {
    ...
    public void submitByRetrofit(User user){
        ...
        Retrofit.Builder builder= new Retrofit.Builder().baseUrl("http://192.168.43.165/volley/").addConverterFactory(GsonConverterFactory.create());
    ...
    public void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "http://192.168.43.165/volley/User_Registration.php";
